...
const data = [
	{
		title: 'FDR Footwear',
		img: [
			'./img/info-img/fdr1.png',
			'./img/info-img/fdr2.png',
			'./img/info-img/fdr3.png'
		],
		description:
			"FDR-footwear is an E-commerce project based on the  Complete React Developer Udemy course. <br> <br> First time I followed the course as it is, and the second time I tried to implement some things on my own, I don't add a project that isn't built from scratch but I liked what I learned on this project so I decided to include it.<br> <br> I learned a lot on this project about routing, redux-thunk, redux-saga, firebase, selectors, styled-components, and testing.",
		tech: [
			'React.js',
			'Redux',
			'Redux-Saga',
		...
		git: 'https://github.com/Aleksandar-Jocovic/feather-footwear-e-comerce',
		demo: 'https://fdr-footwear.herokuapp.com/'
	},
	{
		title: 'Norms-App',
		img: [
			'./img/info-img/nor1.png',
			'./img/info-img/nor2.png',
			'./img/info-img/nor4.png'
		],
		alt: [
			'Norms app first image log in / sing in page',
			'Norms app second image form to add norms',
			'Norms app last image main page layout',
			''
		],
		description:
			"It's a habit tracker application. Building this app I worked with Context, authentication, protected routes, and data visualization.",
	...
	},
	{
		title: 'CV Free',
		img: [
			'./img/info-img/cvf1.png',
			'./img/info-img/cvf2.png',
			'./img/info-img/cvf3.png'
		],
		alt: [
			'CV free first image work section',
			'CV free second image skills section',
			'CV free last image profile summary'
		],
		description:
			'Online Circum Vitae (CV) building application. On this project, I learned about jsPdf library, uploading, and downloading files.',
		tech: ['React.js', 'jspdf'],
	...
	},
	{
		title: 'Project Base',
		img: [
			'./img/info-img/bas1.png',
			'./img/info-img/bas2.png',
			'./img/info-img/bas3.png'
		],
		description:
			'This project is a simple website with interesting design and overlapping animation in the third section.',
	...
	},
	{
		title: 'County Info',
		img: [
			'./img/info-img/cou1.png',
			'./img/info-img/cou2.png',
			'./img/info-img/cou3.png'
		],
		description: 'Simple web app where I worked with REST Countries API.',
		tech: ['HTML5&CSS3', 'JS', 'React.js', 'Bootstrap4', 'REST Countries API'],
	...
	},
	{
		title: 'Tech Shop',
		img: [
			'./img/info-img/tec1.png',
			'./img/info-img/tec2.png',
			'./img/info-img/tec3.png'
		],
		description:
			'This is one of my first projects. A static website where I practiced implementing stuff that I learned from online tutorials.',
		tech: ['HTML5&CSS3', 'JS'],
	...
	},
	{
		title: 'Random Color',
		img: [
			'./img/info-img/col1.png',
			'./img/info-img/col2.png',
			'./img/info-img/col3.png'
		],
		description:
			'Simple random color generator with redux undo/redo implementation.',
		tech: ['HTML5&CSS3', 'React.js', 'Redux'],
		git:
			'https://github.com/Aleksandar-Jocovic/Random-Color-UNDO-REDO-react-redux',
		demo:
			'https://aleksandar-jocovic.github.io/Random-Color-UNDO-REDO-react-redux/'
	}
];
...
function btnFun(e) {
	if (e.target.classList.contains('pop-up-btn')) {
		if (
			!popOne.classList.contains('pop-up-false') ||
